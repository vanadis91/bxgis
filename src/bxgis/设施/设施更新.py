...
def 设施更新(
    ...
    if 是否根据坐标字段移动设施坐标:
        设施要素路径 = 移动至正确位置(输入要素名称=设施要素路径)
    设施要素路径 = 清理范围外设施(输入要素名称=设施要素路径, 范围要素名称=规划范围线要素名称)
    设施要素路径 = 计算所属区域.计算所属区域(设施要素路径, 工业片区范围线要素名称, 字段映射列表=[[基本信息.设施要素字段映射.所属工业片区字段名称, 基本信息.区域要素字段映射.区域编号字段名称]], 计算方式="内点在区域要素内")
    设施要素路径 = 计算远期预留(输入要素名称=设施要素路径, 城镇集建区要素名称=城镇集建区要素名称, 城镇弹性区要素名称=城镇弹性区要素名称)
...
if __name__ == "__main__":
    ...
    with 环境管理器类.环境管理器类创建(工作空间):
        设施更新("SS_配套设施", 规划范围线要素名称="JX_规划范围线", 工业片区范围线要素名称="JX_工业片区范围线", 城镇集建区要素名称="KZX_城镇集建区", 城镇弹性区要素名称="KZX_城镇弹性区", 输出要素名称="SS_配套设施")
