...
def 字段处理并生成分项(输入要素名称="CZ_三调", 输出要素名称="内存临时"):
    if 输出要素名称 == "内存临时":
        输出要素名称 = "in_memory\\AA_三调字段汉化并生成分项" + "_" + bxarcpy.工具集.生成短GUID()
    # 输入路径 = 工作空间 + 输入路径
