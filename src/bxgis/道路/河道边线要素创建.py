...
<<<<<<<< HEAD:src/bxgis/道路/河道边线生成.py
def 河道边线生成(河道中线要素名称="DL_河道中线", 用地要素名称="DIST_用地规划图", 规划范围线要素名称="JX_规划范围线", 输出要素名称="内存临时"):
========
def 河道边线要素创建(河道中线要素名称="DL_河道中线", 地块要素名称="DIST_用地规划图", 范围要素名称="JX_规划范围线", 输出要素名称="内存临时"):
>>>>>>>> 5461771 (2024-02-17,21:00:27):src/bxgis/道路/河道边线要素创建.py
    if 输出要素名称 == "内存临时":
...
========
        河道边线要素创建("DL_河道中线", "DIST_用地规划图", "JX_规划范围线", "DL_河道边线")
>>>>>>>> 5461771 (2024-02-17,21:00:27):src/bxgis/道路/河道边线要素创建.py
