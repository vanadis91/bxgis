...
def 数据检查(输入要素路径=r"C:\Users\beixiao\Desktop\01.dwg\控规地块", 是否拓扑检查=False, 是否范围检查=True, 是否曲线检查=True, 输出要素路径: Union[str, None] = "内存临时"):
    ...
    输入要素路径_临时 = 要素类.要素创建_通过复制(输入要素路径)
