...
def 入库_街区街坊分村(
    ...
    if "分村" not in 层级列表:
        ...
        要素类.字段计算(合并后要素, "HJRK", "0")
        要素类.字段计算(合并后要素, "CZRK", "0")
        要素类.字段计算(合并后要素, "GD", "0")
        要素类.字段计算(合并后要素, "CZBJ", "0")
        要素类.字段计算(合并后要素, "CXMJ", "0")
        要素类.字段计算(合并后要素, "CZMJ", "0")
    if "街区" not in 层级列表 and "街坊" not in 层级列表:
        # 要素类.字段删除(合并后要素, ["RK", "JZZL", "ZZZL", "GYZL", "SYZL"])
        要素类.字段计算(合并后要素, "RK", "0")
        要素类.字段计算(合并后要素, "JZZL", "0")
        要素类.字段计算(合并后要素, "ZZZL", "0")
        要素类.字段计算(合并后要素, "GYZL", "0")
        要素类.字段计算(合并后要素, "SYZL", "0")
    数据库 = 基本信息.项目信息.工作空间
