...
def 区域更新(区域要素名称="JX_街坊范围线", 用地要素名称="DIST_用地规划图", 用地要素中所属区域字段名称="所属街区", 区域要素中编号字段名称="区域编号", 永久基本农田要素名称="KZX_基本农田", 生态保护红线要素名称="KZX_生态保护红线", 村庄建设边界要素名称="KZX_村庄建设边界", 设施要素名称="SS_配套设施", 设施要素中所属区域字段名称="所属街区"):
