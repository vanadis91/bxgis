...
def 入库_工业片区(区域要素名称="JX_工业片区范围线", 地块要素名称="DIST_用地规划图", 设施要素名称="SS_配套设施", 单元名称="临江单元", 区域编号字段名称="区域编号", 区域名称字段名称="区域名称"):
        ...
        for x in 游标:
            if x["所属工业片区"] != "":
                ...
                if 字.匹配正则(x["地类编号"], "^(10|11).*"):
                    统计数据[x["所属工业片区"]]["总工业用地面积"] += 转浮(x["Shape_Area"])
                    统计数据[x["所属工业片区"]]["总工业建筑面积"] += 转浮(x["工业建筑面积"])
            ...
            if x["所属工业片区"] not in ["", None]:
                ...
                if x["设施类型"] in ["教育", "商服", "社会福利", "社区治理", "生态环境", "体育", "文化", "医疗"]:
                    ...
                    if x["设施名称"] not in 统计数据[x["所属工业片区"]]["配套设施汇总"]:
                        统计数据[x["所属工业片区"]]["配套设施汇总"][x["设施名称"]] = [转浮(x["设施数量"]), x["设施规模"]]
                    else:
                        统计数据[x["所属工业片区"]]["配套设施汇总"][x["设施名称"]][0] += 转浮(x["设施数量"])
                    ...
                    if x["设施名称"] not in 统计数据[x["所属工业片区"]]["交通设施汇总"]:
                        统计数据[x["所属工业片区"]]["交通设施汇总"][x["设施名称"]] = [转浮(x["设施数量"]), x["设施规模"]]
                    else:
                        统计数据[x["所属工业片区"]]["交通设施汇总"][x["设施名称"]][0] += 转浮(x["设施数量"])
                    ...
                    if x["设施名称"] not in 统计数据[x["所属工业片区"]]["市政设施汇总"]:
                        统计数据[x["所属工业片区"]]["市政设施汇总"][x["设施名称"]] = [转浮(x["设施数量"]), x["设施规模"]]
                    else:
                        统计数据[x["所属工业片区"]]["市政设施汇总"][x["设施名称"]][0] += 转浮(x["设施数量"])
...
if __name__ == "__main__":
    ...
    with bxarcpy.环境.环境管理器(工作空间):
        入库_工业片区(区域要素名称="JX_工业片区范围线", 单元名称="受降北单元", 地块要素名称="DIST_用地规划图", 设施要素名称="SS_配套设施")
