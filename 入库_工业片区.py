...
def 入库_工业片区(区域要素名称="JX_工业片区范围线", 地块要素名称="DIST_用地规划图", 设施要素名称="SS_配套设施", 单元名称="临江单元", 区域编号字段名称="区域编号", 区域名称字段名称="区域名称", 总工业用地面积字段名称="总工业用地面积", 总工业建筑面积字段名称="总工业建筑面积", 区域主导属性字段名称="区域主导属性", 配套设施汇总字段名称="配套设施汇总", 交通设施汇总字段名称="交通设施汇总", 市政设施汇总字段名称="市政设施汇总"):
...
if __name__ == "__main__":
    ...
    with bxarcpy.环境.环境管理器(工作空间):
        入库_工业片区(区域要素名称="JX_工业片区范围线", 地块要素名称="DIST_用地规划图", 设施要素名称="SS_配套设施", 单元名称="临江单元", 区域编号字段名称="区域编号", 区域名称字段名称="区域名称", 总工业用地面积字段名称="总工业用地面积", 总工业建筑面积字段名称="总工业建筑面积", 区域主导属性字段名称="区域主导属性", 配套设施汇总字段名称="配套设施汇总", 交通设施汇总字段名称="交通设施汇总", 市政设施汇总字段名称="市政设施汇总")
