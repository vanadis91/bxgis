...
def main(工作空间=r"C:\Users\common\project\J江东区临江控规\临江控规_数据库.gdb"):  # 表达_设置符号系统
    with bxarcpy.环境.环境管理器(工作空间=工作空间, 临时工作空间=工作空间):
        ...
        文档 = bxarcpy.文档.文档读取(文档路径=r"C:\Users\common\project\J江东区临江控规\临江控规_数据库.aprx")
        地图 = 文档.地图列表读取("ALL")[0]
        调试.输出调试(地图)
        ...
        # 图层.符号系统设置_通过lyr图层(图层文件路径=样式2, 映射关系=[["VALUE_FIELD", "", "JQYDDM"]])

        样式3 = r"C:\\Users\\beixiao\\AppConfig\\ArcGIS\\010.符号系统\\符号系统_省国空地类_根据编号.stylx"
        图层.符号系统设置_通过stylx样式(样式文件路径=样式3, 映射关系="$feature.JQYDDM")
