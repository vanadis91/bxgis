...
def 入库_单元(规划范围要素名称="JX_规划范围线", 单元编号="QT12", 单元名称="临江单元", 单元类型: Literal["城镇单元", "乡村单元"] = "城镇单元", 批复时间="", 批复文号="", 编制单位="浙江大学建筑设计研究院有限公司", 单元功能="", 人口规模=3.1512, 跨单元平衡情况=""):
...
if __name__ == "__main__":
    ...
    with bxarcpy.环境.环境管理器(工作空间):
        入库_单元(规划范围要素名称="JX_规划范围线", 单元编号="FY07", 单元名称="受降北单元", 单元类型="城镇单元", 批复时间="", 批复文号="", 编制单位="浙江大学建筑设计研究院有限公司", 单元功能="依托数字经济时代背景、银湖科技城产业平台、受降区位优势，打造以高品质生态居住区与创新产业联动平台为主导的“个性化、生态化、创新化”富阳未来宜居宜业新组团，“生态品质居住+创新智慧生产”的产城人融合活力新单元。", 人口规模=6.8612, 跨单元平衡情况="")
