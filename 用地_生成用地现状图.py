...
if __name__ == "__main__":
    ...
    # main(工作空间=r"C:\Users\common\project\J江东区临江控规\临江控规_数据库.gdb", 输出要素名称="DIST_用地现状图", 规划范围="JX_规划范围线", 需要合并的要素名称列表=["YD_基期细化", "YD_农转用20年及以前", "YD_现状修改1", "YD_农转用21年及以后", "YD_审批信息已实施", "YD_地籍信息", "YD_现状修改2"])
