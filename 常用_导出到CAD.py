...
def 转换_导出到CAD(输入要素名称, 范围要素名称: Union[str, None] = "JX_规划范围线", 需融合地类编号列表=None, 切分阈值=None, 输出CAD路径=r"C:\Users\beixiao\Desktop\01.dwg"):
...
if __name__ == "__main__":
    ...
    with bxarcpy.环境.环境管理器(工作空间):
        转换_导出到CAD("YD_地籍信息", 范围要素名称=None, 需融合地类编号列表=None, 切分阈值=None, 输出CAD路径=r"C:\Users\beixiao\Desktop\01.dwg")
