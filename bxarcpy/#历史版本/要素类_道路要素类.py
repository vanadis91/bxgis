...
class 道路要素类(bxarcpy.要素类):
    ...
    def 道路_创建道路边线要素(self, 地块要素名称="DIST_用地规划图", 范围要素名称="JX_规划范围线", 输出要素名称="DL_道路边线"):
        道路中线要素 = bxarcpy.要素类.要素读取_通过名称(self.名称).要素创建_通过复制()
    ...
    def 道路_创建河道边线要素(self, 地块要素名称="DIST_用地规划图", 范围要素名称="JX_规划范围线", 输出要素名称="DL_河道边线"):
        河道中线要素 = bxarcpy.要素类.要素读取_通过名称(self.名称)
...
if __name__ == "__main__":
    ...
    with bxarcpy.环境.环境管理器(工作空间):
        道路要素对象 = 道路要素类.道路读取_通过名称("DL_道路中线")
        道路要素对象.道路_创建道路边线要素("DIST_用地规划图", "JX_规划范围线", "DL_道路边线")
        河道要素对象 = 道路要素类.道路读取_通过名称("DL_河道中线")
        河道要素对象.道路_创建河道边线要素("DIST_用地规划图", "JX_规划范围线", "DL_河道边线")
