...
if __name__ == "__main__":
    ...
    # main(工作空间=r"C:\Users\beixiao\Desktop\新建文件地理数据库.gdb", CAD路径列表=[r"C:\Users\beixiao\Desktop\XYKG.dwg"], 输出要素=r"\AA_现有控规")
    # main(工作空间=r"C:\Users\beixiao\Desktop\新建文件地理数据库.gdb", CAD路径列表=[r"C:\Users\beixiao\Desktop\YKG.dwg"], 输出要素=r"\AA_原控规")
